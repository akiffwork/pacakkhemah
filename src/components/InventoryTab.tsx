              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {items.map(g => (
                  <div key={g.id} className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100 hover:border-slate-200 transition-all group">
                    <div className="w-14 h-14 rounded-xl bg-white p-0.5 shadow-sm overflow-hidden flex-shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {g.linkedItems && g.linkedItems.length > 0 && (
                        <p className="text-[8px] text-purple-500 mt-1">
                          <i className="fas fa-link mr-1"></i>
                          {g.linkedItems.length} linked items
                        </p>
                      )}
                    </div>
